...
public abstract class AbstractMove implements Cloneable {
	...
	private int maxPP, actPP, damage, precision, golpes, chnAtkYou, chnAtkRiv, chnDefYou, chnDefRiv, chnSpAtkYou,
	 ...
	 *                           movimiento
	 * @param golpes             Entero que representa la cantidad de golpes que
	...
	protected AbstractMove(Estado aplicaEstado, CondArena aplicaCondArena, CondPosiPkmn aplicaCondPosiPkmn, Tipo tipo,
			...
			int golpes, int chnAtkYou, int chnAtkRiv, int chnDefYou, int chnDefRiv, int chnSpAtkYou, int chnSpAtkRiv,
