...
public class MoveAtkPerc extends MoveAtk {
	 ...
	 */
	public MoveAtkPerc(Estado aplicaEstado, Tipo tipo, String nombre, int maxPP, int chnAtkYou,
		...
		super(aplicaEstado, tipo, nombre, maxPP, 0, chnAtkYou, chnAtkRiv, chnDefYou, chnDefRiv, chnSpAtkYou, chnSpAtkRiv,
