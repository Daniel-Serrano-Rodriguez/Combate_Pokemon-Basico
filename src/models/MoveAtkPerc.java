...
public class MoveAtkPerc extends MoveAtk {
	 ...
	 */
	public MoveAtkPerc(Estado aplicaEstado, Tipo tipo, String nombre, String descripcion, int maxPP, int chnAtkYou,
		...
		super(aplicaEstado, tipo, nombre, descripcion, maxPP, 0, chnAtkYou, chnAtkRiv, chnDefYou, chnDefRiv,
