...
public class MoveAtkCarga extends MoveAtk {
	 ...
	 * 
	 * @param aplicaEstado     Enum 'Estado' que representa el estado que se aplica
	 *                         al objeto 'Pokemon'
	 * @param condPosiPkmn     Enum 'CondPosiPkmn' que representa la condición que
	 *                         se aplica al objeto 'Pokemon'
	 ...
	 *                         QUE SEA PEQUEÑA (E.g. Hace 20 puntos de frio)
	 ...
	 * @param turnosNecesarios Entero que representa cuantos turnos tarda en cargar
	 *                         el ataque
	 ...
	 */
	public MoveAtkCarga(Estado aplicaEstado, CondPosiPkmn condPosiPkmn, Tipo tipo, Clase clase, Moves move,
